                    ...
                    <div className="col-sm-12">
                        <div className="card">
                            <div className="card-header">
                                <h4 className= "">
                                    Customer Data
                                    <Link to={'add-student'} className="btn btn-success btn-sm float-end m-1 ">Add Customer</Link>
                                    <Link to={'add-product'} className="btn btn-danger btn-sm float-end m-1 ">Add Product</Link>
                                    <Link to={'add-brand'} className="btn btn-primary btn-sm  float-end m-1 ">Add Brand</Link>
                                    <Link to={'add-category'} className="btn btn-info btn-sm  float-end m-1">Add category</Link>
                                </h4>
                            </div>
